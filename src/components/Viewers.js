...
const Viewers = () => {
  return (
    <Container>
      ...
      <Wrap>
        <img src="assets/images/viewers-pixar.png" alt="Viewer 2" />
        <video autoPlay={true} loop={true} playsInline={true}>
          <source src="assets/videos/1564676714-pixar.mp4" type="video/mp4" />
        </video>
      </Wrap>
      <Wrap>
        <img src="assets/images/viewers-marvel.png" alt="Viewer 3" />
        <video autoPlay={true} loop={true} playsInline={true}>
          <source src="assets/videos/1564676115-marvel.mp4" type="video/mp4" />
        </video>
      </Wrap>
      <Wrap>
        <img src="assets/images/viewers-starwars.png" alt="Viewer 4" />
        <video autoPlay={true} loop={true} playsInline={true}>
          <source
      ...
      <Wrap>
        <img src="assets/images/viewers-national.png" alt="Viewer 5" />
        <video autoPlay={true} loop={true} playsInline={true}>
          <source
